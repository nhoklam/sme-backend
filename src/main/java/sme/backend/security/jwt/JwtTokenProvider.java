...
public class JwtTokenProvider {
     ...
     */
    public String generateAccessToken(UserPrincipal userPrincipal, Long customExpirationMs) {
        Date now = new Date();
        long expirationTime = customExpirationMs != null ? customExpirationMs : jwtExpirationMs;
    ...
    public String generateAccessToken(UserPrincipal userPrincipal) {
        return generateAccessToken(userPrincipal, null);
    }
