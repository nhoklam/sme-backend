...
public class Order extends BaseEntity {
    ...
    public enum OrderStatus {
        PAYMENT_PENDING, PENDING, PACKING, WAITING_FOR_CONSOLIDATION, SHIPPING, DELIVERED, CANCELLED, RETURNED
    }
    ...
    private void validateTransition(OrderStatus from, OrderStatus to) {
        boolean valid = switch (from) {
            case PAYMENT_PENDING -> to == OrderStatus.PENDING || to == OrderStatus.CANCELLED;
            case WAITING_FOR_CONSOLIDATION -> to == OrderStatus.PENDING || to == OrderStatus.CANCELLED;
            case PENDING -> to == OrderStatus.PACKING || to == OrderStatus.CANCELLED || (this.type == OrderType.BOPIS && to == OrderStatus.DELIVERED);
